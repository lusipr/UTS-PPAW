            ...
            <div class="card">
                <div class="card-header">
                    <div style="display: flex;justify-content: space-between;align-items: center;">
                        ...
                        <div class="float-right">
                            <h2><a href="{{ route('pendaftaran.create') }}" class="btn btn-primary btn-sm">Daftar</a></h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="col-12 table-responsive">
                        <table class="table table-bordered " id="pendaftaran_datatable">
                            <thead>
                                <tr>
                                    <th width="10px">No</th>
...
<script type="text/javascript">
    $(function () {
        var table = $('#pendaftaran_datatable').DataTable({
            order: [[6, 'desc']],
            processing: true,
            serverSide: true,
